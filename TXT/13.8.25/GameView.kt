...
// Added 4 more balls
    ...
    fun updateHolePositions(
        ...
        if (currentLevel <= 6) {
            ...
            // —— LEVELS 7–10 & 16–19: Level-6 holes + incremental 90° additions ——
            ...
            val extra = (currentLevel - 6).coerceIn(0, 4)   // 7→1 … 10→4, 16–19 also capped at 4
            for (ringIdx in 1..extra) {
                ...
                val a3     = angle0 + sector      // +90° third hole
