...
class GameView @JvmOverloads constructor(
    ...
    var removeTimeLimit: Boolean = false
        set(value) {
            ...
            field = value
            if (was && !value) {
                // Timer entitlement revoked; enable timer on next level to keep current state stable
                enableTimerNextLevel = true
            }
            invalidate()
        }
    private var enableTimerNextLevel = false
 ...
 */
    ...
    fun startLevel(resume: Boolean = false) {
        gamePaused = false
        levelFailed = false
        ...
        if (enableTimerNextLevel) {
            enableTimerNextLevel = false
        }
