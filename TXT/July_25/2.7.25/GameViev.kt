            ...
            if (currentLevel != 19) {
                ...
                handler.postDelayed({
                    val dialog = AlertDialog.Builder(context)
                        ...
                        .setMessage("You have reached the highest level. Would you like to restart the Game?")
                    ...
                    dialog.setOnShowListener { dlgInterface ->
                        ...
                        val tv = alert.findViewById<TextView>(androidx.appcompat.R.id.alertTitle)
                ...
                when (which) {
                    ...
                    7 -> {
                        val intent = Intent(Intent.ACTION_SENDTO).apply {
                            data = Uri.parse("mailto:support@veryeasygames.com")
