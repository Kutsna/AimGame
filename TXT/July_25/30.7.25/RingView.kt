    ...
    override fun onDraw(canvas: Canvas) {
        ...
        when (type) {
            ...
            Type.GOLD -> {
                ...
                outerPaint.strokeWidth = 1f  * scale
                mainPaint.color        = Color.parseColor("#FFD700")
                mainPaint.strokeWidth  = 26f * scale
                holePaint.strokeWidth  = 1f  * scale
                drawRing(canvas, cx, cy, 50f*scale, 41f*scale, 1f*scale)
            }
            Type.GREEN -> {
            ...
            Type.RED -> {
                ...
                outerPaint.strokeWidth = 3f  * scale
                mainPaint.color        = Color.parseColor("#FF0000")
                mainPaint.strokeWidth  = 28f * scale
                holePaint.strokeWidth  = 8f  * scale
                drawRing(canvas, cx, cy, 50f*scale, 41f*scale, 1f*scale)
            }
        }
    }
