...
class GameView @JvmOverloads constructor(
    ...
    private val optionsList = listOf("Menu") // , "Set Tilt", "Set Flat")
...
*/
            ...
            val elapsedTime = if (currentLevel >= 4 && !timerStarted) 0f else rawElapsed
            ...
            if (currentLevel >= 4 && firstSnapOccurred) {       // was showTimer
        ...
        for ((idx, ball) in balls.take(maxBalls).withIndex()) {
            ...
            for (h in allowed) {
                ...
                if ((distB < thresh && speedB < 1f) || distB < 10f) {
                    ...
                    if (currentLevel >= 4 && !timerStarted && firstSnapOccurred) {
                        timerStarted    = true
                        levelStartTime  = System.currentTimeMillis()
                    }
            ...
            if (balls.none{it.active} && !failureAlertShown) {
                ...
                failureDialogRunnable = Runnable {
                    val dialog = AlertDialog.Builder(context)
                        ...
                        .setNegativeButton("Restart last Level $currentLevel at Score: $levelStartScore") { _, _ -> startLevel() }
                        .setCancelable(false)
                        .create()
                    dialog.window?.apply {
