...
*/
    ...
    private fun showInstructionDialog() {
        ...
        // 1) Inflate the exact same 'dialog_start.xml'
        val dialogView = LayoutInflater.from(context)
            .inflate(R.layout.dialog_start, null)
        ...
        // 4) Set the title & multi-line instruction
        tvTitle.text = "Welcome to AimGame!"
        playSound("success")
        tvTitle.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18f)   // title = 24sp
        tvMessage.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12f) // message = 18sp
        tvMessage.setTextColor(Color.GREEN)  // or Color.parseColor("#FF8800")
        val fullText = """
    Tilt your phone/tablet to
    drop the ball into hole.
